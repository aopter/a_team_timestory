package com.example.timesequence.constant;


import com.example.timesequence.entity.*;
...
public class Constant {
    ...
    //当前登录的用户
    public static com.example.timesequence.entity.User User = new User();
    //历史上的今天事件集合
    public static List<HistoryDay> historyDays = new ArrayList<>();
    //当前登录用户解锁的朝代
    public static List<UserUnlockDynasty> UnlockDynasty = new ArrayList<>();
    //规则详情
    public static com.example.timesequence.entity.Rule rule;
    //当前登录用户解锁的某朝代的事件
