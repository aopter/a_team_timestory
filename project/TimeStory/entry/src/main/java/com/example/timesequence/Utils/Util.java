...
public class Util {
    ...
    private static final String BUNDLE_NAME = "com.example.timesequence";

    // HiLogLabel定义了域信息和标签等
    private static final HiLogLabel LOG_LABEL = new HiLogLabel(HiLog.LOG_APP, 0x00101, "timesequence");
